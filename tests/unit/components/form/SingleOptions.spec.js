...
import { SingleOptions } from "@/components/form";

describe('SingleOptions.vue', () => {
  describe('Initialize', () => {
    let value;

    it('mount', () => {
      const wrapper = shallowMount(SingleOptions, {
        propsData: {
          value,
    ...
    it('複数選択オプションがtrueにならないこと', () => {
      ...
      expect(select.attributes('multiple')).not.toBe("true");
    });
